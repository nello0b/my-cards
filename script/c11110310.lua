...
function s.initial_effect(c)
	--special summon from hand and equip a tuner
	...
	c:RegisterEffect(e1)
	--banish from GY to special summon a Dragunity dragon monster from GY
...
function s.cfilter(c)
	return c:IsFacedown() or not (c:IsRace(RACE_DRAGON) or c:IsRace(RACE_WINDBEAST))
end
